        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="nav nav-pills nav-justified">
                    <li class="active"><a href="#" data-toggle="pill">PV</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="generated">
                        ...
                        <form action="ajoutContenu.do" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" name="contenu/typecontenu" value="Pv" hidden="">
                            <input type="text" name="typeContenu/page" value="Pv" hidden="">
